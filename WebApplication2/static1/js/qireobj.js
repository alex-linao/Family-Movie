...
var loginhtml;
function qireuser() {};
qireuser.prototype.urls = new Array(Root + 'index.php?s=User-Home-flushinfo', Root + 'index.php?s=User-Center-getremindnew');

qireuser.prototype.gu = function(e) {
    $.get(Root + 'index.php?s=User-Home-flushinfo', '', 
    function(result) {
